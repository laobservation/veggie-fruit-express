  ...
  return (
    <Sheet open={effectiveIsOpen} onOpenChange={handleClose}>
      <SheetContent className="flex flex-col h-full w-full sm:max-w-md">
        <SheetHeader>
          <SheetTitle>
            {showDeliveryForm ? "Informations de livraison" : "Votre Panier"}
          </SheetTitle>
        </SheetHeader>
          ...
          <>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="flex items-center mt-2">
                      ...
                      <Button 
                        ...
                        size="icon" 
                        onClick={() => updateQuantity(item.product.id, item.quantity + 1)} 
                        className="h-7 w-7 bg-green-600 hover:bg-green-500 text-white"
                      >
                      ...
                      <div className="ml-auto font-medium">
                        {formatPrice((item.product.price + 
                          (item.selectedServices?.reduce((acc, service) => acc + service.price, 0) || 0)) * 
                          item.quantity)}
                      </div>
                    </div>
                  </div>
            ...
            <div className="border-t pt-4">
              ...
              <Button 
                ...
                className="w-full text-white mb-2 bg-green-600 hover:bg-green-500"
              >
