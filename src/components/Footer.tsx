    ...
    <footer className="bg-veggie-light mt-12 pt-8 pb-4">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-semibold text-veggie-dark mb-4">Veggie Express</h3>
            <p className="text-gray-600 mb-4">
              Fresh fruits and vegetables delivered right to your doorstep.
            </p>
            <div className="flex space-x-4">
              <a href="#" className="text-veggie-primary hover:text-veggie-dark">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-600 hover:text-veggie-primary">Home</Link></li>
              <li><Link to="/fruits" className="text-gray-600 hover:text-veggie-primary">Fruits</Link></li>
              <li><Link to="/vegetables" className="text-gray-600 hover:text-veggie-primary">Vegetables</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-600">
              ...
              <li className="flex items-center gap-2">
                ...
                <span>info@veggieexpress.com</span>
              </li>
              <li className="flex items-center gap-2">
        ...
        <div className="border-t border-gray-200 mt-8 pt-4 text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} Veggie Express. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
